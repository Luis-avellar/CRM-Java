...
const pushToBrazilian = brazilianFoods.push('Coxinha', null, 'Brigadeiro')
...
const foodsInfo = `Até aqui, array "brazilianFoods" possui ${brazilianFoods.length} itens:${brazilianFoods[0]} ${brazilianFoods[1]} ${brazilianFoods[2]}`
...
*/
dogNamesR = dogNames.join(', ')
//console.log(dogNamesR)
...
//const lastDogName = dogNames.pop('Matilda')
...
const dessert = `${dogNames[0].slice(3, 5)}${dogNames[1].slice(2, 4)}${dogNames[4].slice(2, 4)}`

//console.log(`A ${dessert.replace('n','d')} é um doce à base de cocô, tradicional na América Latina e em Angola`)

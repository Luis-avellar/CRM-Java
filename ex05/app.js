...
*/
//for(let i=1;i<11;i++){
    //console.log(`Esta é a ${i} vez que esta frase é exibida no console DevTools`)
//}
...
//for(let i = 0;i<cities.length;i++){
    //upperCaseCities = cities.toUpperCase()
//}
//console.log(upperCaseCities) ERRADO!

/*for(let i=0;i<cities.length;i++){
    upperCaseCities=cities.push(cities[i].toUpperCase())
}
console.log(upperCaseCities) CORRETO! */ 
...
/*for(let i=0;i<names.length;i++){
    const templateHTML = `<li>${names[0]}</li><li>${names[1]}</li><li>${names[2]}</li>`
    console.log(templateHTML)
} Fiz diferente! */
/*for(let i=0;i<names.length;i++){
    tempHTML +=`<li>${names[i]}</li>`
}
console.log(tempHTML)CORRETO*/
